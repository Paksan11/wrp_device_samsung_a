...
# Assert
TARGET_OTA_ASSERT_DEVICE := m51,m51nsxx
...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/m51/prebuilt/Image.gz-dtb
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPTD22A002"
